...
//         alunos = new ArrayList<>();
//         alunos.add(new Aluno("Marcelo", "734.474.247-02", "XXXXXX", "Planejada Vista", "BP248376-X", "marcelinho.paulo@gmail.com"));
//         alunos.add(new Aluno("Vinicius", "444.333.111-15", "YYYYYY", "Rua y", "bp3333", "vinicius@gmail.com")); 
//     }
